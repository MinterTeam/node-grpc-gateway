...
type ApiServiceClient interface {
	...
	LimitOrdersByOwner(ctx context.Context, in *LimitOrdersByOwnerRequest, opts ...grpc.CallOption) (*LimitOrdersResponse, error)
	// BestTrade
	//
...
func (c *apiServiceClient) WaitLists(ctx context.Context, in *WaitListsRequest, opts ...grpc.CallOption) (*WaitListsResponse, error) {
	out := new(WaitListsResponse)
	err := c.cc.Invoke(ctx, "/api_pb.ApiService/WaitLists", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServiceClient) LimitOrdersByOwner(ctx context.Context, in *LimitOrdersByOwnerRequest, opts ...grpc.CallOption) (*LimitOrdersResponse, error) {
	out := new(LimitOrdersResponse)
	err := c.cc.Invoke(ctx, "/api_pb.ApiService/LimitOrdersByOwner", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiServiceServer interface {
	...
	//
	// LimitOrdersByOwner returns orders by owner.
	LimitOrdersByOwner(context.Context, *LimitOrdersByOwnerRequest) (*LimitOrdersResponse, error)
	// BestTrade
	//
	// BestTrade returns optimal exchange route.
...
func (UnimplementedApiServiceServer) WaitLists(context.Context, *WaitListsRequest) (*WaitListsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WaitLists not implemented")
}
...
func (UnimplementedApiServiceServer) LimitOrdersByOwner(context.Context, *LimitOrdersByOwnerRequest) (*LimitOrdersResponse, error) {
...
func _ApiService_WaitLists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitListsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServiceServer).WaitLists(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_pb.ApiService/WaitLists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).WaitLists(ctx, req.(*WaitListsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ApiService_LimitOrdersByOwner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LimitOrdersByOwnerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServiceServer).LimitOrdersByOwner(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_pb.ApiService/LimitOrdersByOwner",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).LimitOrdersByOwner(ctx, req.(*LimitOrdersByOwnerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ApiService_LimitOrdersByOwner_Handler,
		},
		{
