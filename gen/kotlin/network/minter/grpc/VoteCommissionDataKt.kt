...
inline fun voteCommissionData(block: network.minter.grpc.VoteCommissionDataKt.Dsl.() -> Unit): network.minter.grpc.VoteCommissionData =
  network.minter.grpc.VoteCommissionDataKt.Dsl._create(network.minter.grpc.VoteCommissionData.newBuilder()).apply { block() }._build()
object VoteCommissionDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.VoteCommissionData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.VoteCommissionData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.VoteCommissionData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.VoteCommissionData.copy(block: network.minter.grpc.VoteCommissionDataKt.Dsl.() -> Unit): network.minter.grpc.VoteCommissionData =
  network.minter.grpc.VoteCommissionDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
