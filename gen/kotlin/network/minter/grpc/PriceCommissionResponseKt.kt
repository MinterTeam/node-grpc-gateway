...
inline fun priceCommissionResponse(block: network.minter.grpc.PriceCommissionResponseKt.Dsl.() -> Unit): network.minter.grpc.PriceCommissionResponse =
  network.minter.grpc.PriceCommissionResponseKt.Dsl._create(network.minter.grpc.PriceCommissionResponse.newBuilder()).apply { block() }._build()
object PriceCommissionResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.PriceCommissionResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.PriceCommissionResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.PriceCommissionResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.PriceCommissionResponse.copy(block: network.minter.grpc.PriceCommissionResponseKt.Dsl.() -> Unit): network.minter.grpc.PriceCommissionResponse =
  network.minter.grpc.PriceCommissionResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
