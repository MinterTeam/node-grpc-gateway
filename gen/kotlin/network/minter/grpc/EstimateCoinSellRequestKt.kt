...
inline fun estimateCoinSellRequest(block: network.minter.grpc.EstimateCoinSellRequestKt.Dsl.() -> Unit): network.minter.grpc.EstimateCoinSellRequest =
  network.minter.grpc.EstimateCoinSellRequestKt.Dsl._create(network.minter.grpc.EstimateCoinSellRequest.newBuilder()).apply { block() }._build()
object EstimateCoinSellRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.EstimateCoinSellRequest.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.EstimateCoinSellRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.EstimateCoinSellRequest = _builder.build()
    ...
    fun com.google.protobuf.kotlin.DslList<kotlin.Long, RouteProxy>.clear() {
      _builder.clearRoute()
    }val buyCase: network.minter.grpc.EstimateCoinSellRequest.BuyCase
      @JvmName("getBuyCase")
    ...
    val sellCase: network.minter.grpc.EstimateCoinSellRequest.SellCase
      @JvmName("getSellCase")
    ...
    val commissionCase: network.minter.grpc.EstimateCoinSellRequest.CommissionCase
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.EstimateCoinSellRequest.copy(block: network.minter.grpc.EstimateCoinSellRequestKt.Dsl.() -> Unit): network.minter.grpc.EstimateCoinSellRequest =
  network.minter.grpc.EstimateCoinSellRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
