...
inline fun createCoinData(block: network.minter.grpc.CreateCoinDataKt.Dsl.() -> Unit): network.minter.grpc.CreateCoinData =
  network.minter.grpc.CreateCoinDataKt.Dsl._create(network.minter.grpc.CreateCoinData.newBuilder()).apply { block() }._build()
object CreateCoinDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.CreateCoinData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.CreateCoinData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.CreateCoinData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.CreateCoinData.copy(block: network.minter.grpc.CreateCoinDataKt.Dsl.() -> Unit): network.minter.grpc.CreateCoinData =
  network.minter.grpc.CreateCoinDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
