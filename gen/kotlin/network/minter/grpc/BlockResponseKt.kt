...
inline fun blockResponse(block: network.minter.grpc.BlockResponseKt.Dsl.() -> Unit): network.minter.grpc.BlockResponse =
  network.minter.grpc.BlockResponseKt.Dsl._create(network.minter.grpc.BlockResponse.newBuilder()).apply { block() }._build()
object BlockResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.BlockResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.BlockResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.BlockResponse = _builder.build()
     ...
     */
     val validators: com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>
      @kotlin.jvm.JvmSynthetic
      get() = com.google.protobuf.kotlin.DslList(
    ...
    fun com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>.add(value: network.minter.grpc.BlockResponse.Validator) {
    ...
    inline operator fun com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>.plusAssign(value: network.minter.grpc.BlockResponse.Validator) {
      add(value)
    }/**
     * <code>repeated .api_pb.BlockResponse.Validator validators = 10 [json_name = "validators"];</code>
    ...
    fun com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>.addAll(values: kotlin.collections.Iterable<network.minter.grpc.BlockResponse.Validator>) {
    ...
    inline operator fun com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>.plusAssign(values: kotlin.collections.Iterable<network.minter.grpc.BlockResponse.Validator>) {
      addAll(values)
    }/**
     * <code>repeated .api_pb.BlockResponse.Validator validators = 10 [json_name = "validators"];</code>
     * @param index The index to set the value at.
    ...
    operator fun com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>.set(index: kotlin.Int, value: network.minter.grpc.BlockResponse.Validator) {
    ...
    fun com.google.protobuf.kotlin.DslList<network.minter.grpc.BlockResponse.Validator, ValidatorsProxy>.clear() {
      _builder.clearValidators()
    }
    /**
     * <code>.api_pb.BlockResponse.Evidence evidence = 13 [json_name = "evidence"];</code>
     */
    var evidence: network.minter.grpc.BlockResponse.Evidence
      @JvmName("getEvidence")
  ...
  @kotlin.jvm.JvmSynthetic
  inline fun validator(block: network.minter.grpc.BlockResponseKt.ValidatorKt.Dsl.() -> Unit): network.minter.grpc.BlockResponse.Validator =
    network.minter.grpc.BlockResponseKt.ValidatorKt.Dsl._create(network.minter.grpc.BlockResponse.Validator.newBuilder()).apply { block() }._build()
  object ValidatorKt {
    @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
    @com.google.protobuf.kotlin.ProtoDslMarker
    class Dsl private constructor(
      @kotlin.jvm.JvmField private val _builder: network.minter.grpc.BlockResponse.Validator.Builder
    ) {
      companion object {
        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _create(builder: network.minter.grpc.BlockResponse.Validator.Builder): Dsl = Dsl(builder)
      }

      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _build(): network.minter.grpc.BlockResponse.Validator = _builder.build()
  ...
  @kotlin.jvm.JvmSynthetic
  inline fun evidence(block: network.minter.grpc.BlockResponseKt.EvidenceKt.Dsl.() -> Unit): network.minter.grpc.BlockResponse.Evidence =
    network.minter.grpc.BlockResponseKt.EvidenceKt.Dsl._create(network.minter.grpc.BlockResponse.Evidence.newBuilder()).apply { block() }._build()
  object EvidenceKt {
    @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
    @com.google.protobuf.kotlin.ProtoDslMarker
    class Dsl private constructor(
      @kotlin.jvm.JvmField private val _builder: network.minter.grpc.BlockResponse.Evidence.Builder
    ) {
      companion object {
        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _create(builder: network.minter.grpc.BlockResponse.Evidence.Builder): Dsl = Dsl(builder)
      }

      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _build(): network.minter.grpc.BlockResponse.Evidence = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.BlockResponse.copy(block: network.minter.grpc.BlockResponseKt.Dsl.() -> Unit): network.minter.grpc.BlockResponse =
  network.minter.grpc.BlockResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.BlockResponse.Validator.copy(block: network.minter.grpc.BlockResponseKt.ValidatorKt.Dsl.() -> Unit): network.minter.grpc.BlockResponse.Validator =
  network.minter.grpc.BlockResponseKt.ValidatorKt.Dsl._create(this.toBuilder()).apply { block() }._build()
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.BlockResponse.Evidence.copy(block: network.minter.grpc.BlockResponseKt.EvidenceKt.Dsl.() -> Unit): network.minter.grpc.BlockResponse.Evidence =
  network.minter.grpc.BlockResponseKt.EvidenceKt.Dsl._create(this.toBuilder()).apply { block() }._build()
