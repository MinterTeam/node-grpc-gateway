...
inline fun updateCommissionsEvent(block: network.minter.grpc.UpdateCommissionsEventKt.Dsl.() -> Unit): network.minter.grpc.UpdateCommissionsEvent =
  network.minter.grpc.UpdateCommissionsEventKt.Dsl._create(network.minter.grpc.UpdateCommissionsEvent.newBuilder()).apply { block() }._build()
object UpdateCommissionsEventKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.UpdateCommissionsEvent.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.UpdateCommissionsEvent.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.UpdateCommissionsEvent = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.UpdateCommissionsEvent.copy(block: network.minter.grpc.UpdateCommissionsEventKt.Dsl.() -> Unit): network.minter.grpc.UpdateCommissionsEvent =
  network.minter.grpc.UpdateCommissionsEventKt.Dsl._create(this.toBuilder()).apply { block() }._build()
