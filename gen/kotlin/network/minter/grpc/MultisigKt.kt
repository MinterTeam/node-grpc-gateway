...
inline fun multisig(block: network.minter.grpc.MultisigKt.Dsl.() -> Unit): network.minter.grpc.Multisig =
  network.minter.grpc.MultisigKt.Dsl._create(network.minter.grpc.Multisig.newBuilder()).apply { block() }._build()
object MultisigKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.Multisig.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.Multisig.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.Multisig = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.Multisig.copy(block: network.minter.grpc.MultisigKt.Dsl.() -> Unit): network.minter.grpc.Multisig =
  network.minter.grpc.MultisigKt.Dsl._create(this.toBuilder()).apply { block() }._build()
