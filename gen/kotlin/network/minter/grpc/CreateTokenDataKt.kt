...
inline fun createTokenData(block: network.minter.grpc.CreateTokenDataKt.Dsl.() -> Unit): network.minter.grpc.CreateTokenData =
  network.minter.grpc.CreateTokenDataKt.Dsl._create(network.minter.grpc.CreateTokenData.newBuilder()).apply { block() }._build()
object CreateTokenDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.CreateTokenData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.CreateTokenData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.CreateTokenData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.CreateTokenData.copy(block: network.minter.grpc.CreateTokenDataKt.Dsl.() -> Unit): network.minter.grpc.CreateTokenData =
  network.minter.grpc.CreateTokenDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
