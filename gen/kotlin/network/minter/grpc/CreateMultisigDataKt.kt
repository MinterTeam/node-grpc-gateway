...
inline fun createMultisigData(block: network.minter.grpc.CreateMultisigDataKt.Dsl.() -> Unit): network.minter.grpc.CreateMultisigData =
  network.minter.grpc.CreateMultisigDataKt.Dsl._create(network.minter.grpc.CreateMultisigData.newBuilder()).apply { block() }._build()
object CreateMultisigDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: network.minter.grpc.CreateMultisigData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: network.minter.grpc.CreateMultisigData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): network.minter.grpc.CreateMultisigData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun network.minter.grpc.CreateMultisigData.copy(block: network.minter.grpc.CreateMultisigDataKt.Dsl.() -> Unit): network.minter.grpc.CreateMultisigData =
  network.minter.grpc.CreateMultisigDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
