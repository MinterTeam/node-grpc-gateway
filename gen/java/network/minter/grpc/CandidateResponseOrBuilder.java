...
public interface CandidateResponseOrBuilder extends
   ...
   */
  java.util.List<network.minter.grpc.CandidateResponse.Stake> 
      getStakesList();
  /**
   * <pre>
   * List of stakes. Note: filled in when request includes_stakes
   ...
   * <code>repeated .api_pb.CandidateResponse.Stake stakes = 5 [json_name = "stakes"];</code>
   */
  network.minter.grpc.CandidateResponse.Stake getStakes(int index);
  /**
   * <pre>
   * List of stakes. Note: filled in when request includes_stakes
   * </pre>
   ...
   * <code>repeated .api_pb.CandidateResponse.Stake stakes = 5 [json_name = "stakes"];</code>
   */
  java.util.List<? extends network.minter.grpc.CandidateResponse.StakeOrBuilder> 
   ...
   * <code>repeated .api_pb.CandidateResponse.Stake stakes = 5 [json_name = "stakes"];</code>
   */
  network.minter.grpc.CandidateResponse.StakeOrBuilder getStakesOrBuilder(
      int index);
