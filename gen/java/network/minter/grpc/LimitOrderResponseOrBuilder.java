...
public interface LimitOrderResponseOrBuilder extends
   ...
   * @return The coinSell.
   */
  network.minter.grpc.Coin getCoinSell();
  /**
   * <code>.api_pb.Coin coin_sell = 1 [json_name = "coinSell"];</code>
   */
  network.minter.grpc.CoinOrBuilder getCoinSellOrBuilder();
   ...
   * @return The coinBuy.
   */
  network.minter.grpc.Coin getCoinBuy();
  /**
   * <code>.api_pb.Coin coin_buy = 2 [json_name = "coinBuy"];</code>
   */
  network.minter.grpc.CoinOrBuilder getCoinBuyOrBuilder();
