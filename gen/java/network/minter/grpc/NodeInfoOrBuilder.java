...
public interface NodeInfoOrBuilder extends
   ...
   */
  network.minter.grpc.NodeInfo.ProtocolVersion getProtocolVersion();
  /**
   * <code>.api_pb.NodeInfo.ProtocolVersion protocol_version = 8 [json_name = "protocolVersion"];</code>
   */
  network.minter.grpc.NodeInfo.ProtocolVersionOrBuilder getProtocolVersionOrBuilder();
   ...
   * @return The other.
   */
  network.minter.grpc.NodeInfo.Other getOther();
  /**
   * <code>.api_pb.NodeInfo.Other other = 7 [json_name = "other"];</code>
   */
  network.minter.grpc.NodeInfo.OtherOrBuilder getOtherOrBuilder();
}
