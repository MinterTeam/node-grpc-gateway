...
public interface NetInfoResponseOrBuilder extends
   ...
   */
  java.util.List<network.minter.grpc.NetInfoResponse.Peer> 
      getPeersList();
  /**
   * <code>repeated .api_pb.NetInfoResponse.Peer peers = 3 [json_name = "peers"];</code>
   */
  network.minter.grpc.NetInfoResponse.Peer getPeers(int index);
  /**
   * <code>repeated .api_pb.NetInfoResponse.Peer peers = 3 [json_name = "peers"];</code>
   */
  int getPeersCount();
   ...
   * <code>repeated .api_pb.NetInfoResponse.Peer peers = 3 [json_name = "peers"];</code>
   */
  java.util.List<? extends network.minter.grpc.NetInfoResponse.PeerOrBuilder> 
      getPeersOrBuilderList();
  /**
   * <code>repeated .api_pb.NetInfoResponse.Peer peers = 3 [json_name = "peers"];</code>
   */
  network.minter.grpc.NetInfoResponse.PeerOrBuilder getPeersOrBuilder(
      int index);
}
