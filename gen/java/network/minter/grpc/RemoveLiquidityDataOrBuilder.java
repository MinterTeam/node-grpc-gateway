...
public interface RemoveLiquidityDataOrBuilder extends
   ...
   * @return The coin0.
   */
  network.minter.grpc.Coin getCoin0();
  /**
   * <code>.api_pb.Coin coin0 = 1 [json_name = "coin0"];</code>
   */
  network.minter.grpc.CoinOrBuilder getCoin0OrBuilder();
   ...
   * @return The coin1.
   */
  network.minter.grpc.Coin getCoin1();
  /**
   * <code>.api_pb.Coin coin1 = 2 [json_name = "coin1"];</code>
   */
  network.minter.grpc.CoinOrBuilder getCoin1OrBuilder();
