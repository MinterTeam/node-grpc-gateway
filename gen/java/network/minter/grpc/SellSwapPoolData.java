...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return network.minter.grpc.Data.internal_static_api_pb_SellSwapPoolData_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return network.minter.grpc.Data.internal_static_api_pb_SellSwapPoolData_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            network.minter.grpc.SellSwapPoolData.class, network.minter.grpc.SellSwapPoolData.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof network.minter.grpc.SellSwapPoolData)) {
      return super.equals(obj);
    }
    network.minter.grpc.SellSwapPoolData other = (network.minter.grpc.SellSwapPoolData) obj;
  ...
  public static network.minter.grpc.SellSwapPoolData parseFrom(
  ...
  public static network.minter.grpc.SellSwapPoolData parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static network.minter.grpc.SellSwapPoolData parseFrom(
  ...
  public static network.minter.grpc.SellSwapPoolData parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static network.minter.grpc.SellSwapPoolData parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static network.minter.grpc.SellSwapPoolData parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(network.minter.grpc.SellSwapPoolData prototype) {
  ...
  public static final class Builder extends
      ...
      network.minter.grpc.SellSwapPoolDataOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return network.minter.grpc.Data.internal_static_api_pb_SellSwapPoolData_descriptor;
    }
    ...
    // Construct using network.minter.grpc.SellSwapPoolData.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public network.minter.grpc.SellSwapPoolData getDefaultInstanceForType() {
      return network.minter.grpc.SellSwapPoolData.getDefaultInstance();
    }

    @java.lang.Override
    public network.minter.grpc.SellSwapPoolData build() {
      network.minter.grpc.SellSwapPoolData result = buildPartial();
    ...
    @java.lang.Override
    public network.minter.grpc.SellSwapPoolData buildPartial() {
      network.minter.grpc.SellSwapPoolData result = new network.minter.grpc.SellSwapPoolData(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof network.minter.grpc.SellSwapPoolData) {
        return mergeFrom((network.minter.grpc.SellSwapPoolData)other);
      } else {
    ...
    public Builder mergeFrom(network.minter.grpc.SellSwapPoolData other) {
      if (other == network.minter.grpc.SellSwapPoolData.getDefaultInstance()) return this;
      if (coinsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      network.minter.grpc.SellSwapPoolData parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (network.minter.grpc.SellSwapPoolData) e.getUnfinishedMessage();
  ...
  private static final network.minter.grpc.SellSwapPoolData DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new network.minter.grpc.SellSwapPoolData();
  }

  public static network.minter.grpc.SellSwapPoolData getDefaultInstance() {
